...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.feature-card, .about-text, .about-visual, .download-card, .contact-card');
    ...
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            statNumbers.forEach(stat => {
                ...
                if (text === '100%') {
                    stat.textContent = '0%';
                    setTimeout(() => animateCounter(stat, 100), 500);
                } else if (text === '0') {
                    // Already 0, no animation needed
                } else if (text === '∞') {
...
// App preview 3D rotation on hover
...
document.querySelectorAll('.feature-icon, .download-icon, .contact-icon').forEach(icon => {
